    ...
    <div className="gift-activity-page">
      <div className="gift-activity-container">
        ...
        <div className="gift-activity-header">
          ...
          <p>
            View your gift card redemptions, purchases, and balance activity.
          </p>
        </div>
        ...
        <section className="activity-balance-card">
          ...
          <Link to="/gift-cards/reload" className="activity-reload-button">
            Reload Your Balance
          </Link>
        </section>
        ...
        <section className="activity-section">
          <div className="activity-section-heading">
            ...
            <p>Your recent gift card transactions are shown below.</p>
          </div>
          ...
          <div className="activity-card">
            ...
            {activities.length === 0 ? (
              <div className="no-activity">
                ...
                <p>
                  When you redeem, purchase, or reload a gift card,
        ...
        <section className="activity-information">
          ...
          <div className="activity-info-grid">
            <div>
              <h3>Redemptions</h3>
              <p>
                Gift cards that you redeem are added to your available
                gift card balance.
              </p>
            </div>
            ...
            <div>
              <h3>Reloads</h3>
              <p>
                Reloading your balance adds additional funds to your
                gift card balance.
              </p>
            </div>
            ...
            <div>
              <h3>Purchases</h3>
              <p>
                Gift card purchases and other gift card transactions
                can appear in your activity history.
              </p>
            </div>
          </div>
        </section>
